...
namespace MUDhub.Core.Tests
{
    public class MudManagerTests
    {
        ...
        public async Task AddMudSuccessfully()
        {
            ...
            var context = new MudDbContext(options);
            IMudManager mudManager = new MudManager(context);
            var mudName = "MyMud1";
        ...
        public async Task AddMudSuccessfullyWithDescription()
        {
            ...
            var (mudManager, context) = await CreateMudManagerAsync();
        ...
        [Fact]
        public async Task RequestUserToJoinInPulicMudShouldFail()
        {
            var (mudManager, context) = await CreateMudManagerAsync();
        ...
        private static async Task<(IMudManager, MudDbContext)> CreateMudManagerAsync()
        {
